...
game_source='\n'.join([math_js,core,read('support.js'),read('barrel-art.js'),read('media.js'),read('scratch.js'),read('viewport.js'),game])
...
html=html.replace('Лото Студия <b>1.0</b>','Лото Студия <b>1.2</b>')
