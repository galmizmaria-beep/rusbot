...
game_source='\n'.join([math_js,core,read('support.js'),read('barrel-art.js'),read('media.js'),read('storage.js'),read('scratch.js'),read('viewport.js'),game])
